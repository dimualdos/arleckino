...
import type { ApiV1OrdersCreateMutationRequest, ApiV1OrdersCreateMutationResponse, ApiV1OrdersCreate201 } from "../../../models/ts/apiController/ApiV1OrdersCreate"
import type { UseMutationOptions, UseMutationResult } from "@tanstack/react-query"

type ApiV1OrdersCreateClient = typeof client<ApiV1OrdersCreateMutationResponse, ApiV1OrdersCreate201, ApiV1OrdersCreateMutationRequest>
type ApiV1OrdersCreate = {
  data: ApiV1OrdersCreateMutationResponse
  error: any
  request: ApiV1OrdersCreateMutationRequest
  pathParams: never
  queryParams: never
  headerParams: never
  response: Awaited<ReturnType<ApiV1OrdersCreateClient>>
  client: {
    parameters: Partial<Parameters<ApiV1OrdersCreateClient>[0]>
    return: Awaited<ReturnType<ApiV1OrdersCreateClient>>
  }
}
/**
 ...
 * @link /api/v1/orders/ */
export function useApiV1OrdersCreate(
  options: {
    mutation?: UseMutationOptions<ApiV1OrdersCreate["response"], ApiV1OrdersCreate["error"], ApiV1OrdersCreate["request"]>
    client?: ApiV1OrdersCreate["client"]["parameters"]
  } = {},
): UseMutationResult<ApiV1OrdersCreate["response"], ApiV1OrdersCreate["error"], ApiV1OrdersCreate["request"]> {
  const { mutation: mutationOptions, client: clientOptions = {} } = options ?? {}
  return useMutation<ApiV1OrdersCreate["response"], ApiV1OrdersCreate["error"], ApiV1OrdersCreate["request"]>({
    mutationFn: async (data) => {
      const res = await client<ApiV1OrdersCreate["data"], ApiV1OrdersCreate["error"], ApiV1OrdersCreate["request"]>({
        method: "post",
        url: `/api/v1/orders/`,
        data,
        ...clientOptions,
