...
export async function apiV1UserProfileWithdrawalWalletsList(
  params?: ApiV1UserProfileWithdrawalWalletsListQueryParams,
  options: Partial<Parameters<typeof client>[0]> = {},
): Promise<ResponseConfig<ApiV1UserProfileWithdrawalWalletsListQueryResponse>> {
  const res = await client<ApiV1UserProfileWithdrawalWalletsListQueryResponse>({
    method: "get",
