...
export async function apiV1UserAdminUserBlockUpdate(
  { block_pk, id }: ApiV1UserAdminUserBlockUpdatePathParams,
  data: ApiV1UserAdminUserBlockUpdateMutationRequest,
  options: Partial<Parameters<typeof client>[0]> = {},
): Promise<ResponseConfig<ApiV1UserAdminUserBlockUpdateMutationResponse>> {
  const res = await client<ApiV1UserAdminUserBlockUpdateMutationResponse, ApiV1UserAdminUserBlockUpdateMutationRequest>({
    method: "put",
