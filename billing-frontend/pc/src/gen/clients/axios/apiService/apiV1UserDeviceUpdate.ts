...
export async function apiV1UserDeviceUpdate(
  { id }: ApiV1UserDeviceUpdatePathParams,
  data: ApiV1UserDeviceUpdateMutationRequest,
  options: Partial<Parameters<typeof client>[0]> = {},
): Promise<ResponseConfig<ApiV1UserDeviceUpdateMutationResponse>> {
  const res = await client<ApiV1UserDeviceUpdateMutationResponse, ApiV1UserDeviceUpdateMutationRequest>({
    method: "put",
