...
export const apiV1ServiceAdminServerListListQueryParamsSchema = z
  ...
  .optional()
export const apiV1ServiceAdminServerListListQueryResponseSchema = z.object({
  count: z.number(),
  next: z.string().nullable().optional(),
  previous: z.string().nullable().optional(),
  results: z.array(z.lazy(() => serverSchema)),
})
