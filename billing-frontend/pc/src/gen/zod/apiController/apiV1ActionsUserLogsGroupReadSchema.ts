...
export const apiV1ActionsUserLogsGroupReadPathParamsSchema = z.object({ groupId: z.string() })
export const apiV1ActionsUserLogsGroupReadQueryParamsSchema = z
  ...
  .optional()
export const apiV1ActionsUserLogsGroupReadQueryResponseSchema = z.object({
  count: z.number(),
