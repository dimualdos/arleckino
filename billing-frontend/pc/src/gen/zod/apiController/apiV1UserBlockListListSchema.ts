...
export const apiV1UserBlockListListQueryParamsSchema = z
  ...
  .optional()
export const apiV1UserBlockListListQueryResponseSchema = z.object({
  count: z.number(),
  next: z.string().nullable().optional(),
  previous: z.string().nullable().optional(),
  results: z.array(z.lazy(() => userBlockSchema)),
})
