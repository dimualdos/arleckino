...
export const apiV1ActionsAdminTypesListQueryParamsSchema = z
  ...
  .optional()
export const apiV1ActionsAdminTypesListQueryResponseSchema = z.object({
  count: z.number(),
  next: z.string().nullable().optional(),
  previous: z.string().nullable().optional(),
  results: z.array(z.lazy(() => actionTypeSchema)),
})
