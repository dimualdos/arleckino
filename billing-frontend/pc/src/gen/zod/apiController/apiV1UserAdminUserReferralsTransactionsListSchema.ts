...
export const apiV1UserAdminUserReferralsTransactionsListPathParamsSchema = z.object({ id: z.string() })
export const apiV1UserAdminUserReferralsTransactionsListQueryParamsSchema = z
  ...
  .optional()
export const apiV1UserAdminUserReferralsTransactionsListQueryResponseSchema = z.object({
  count: z.number(),
