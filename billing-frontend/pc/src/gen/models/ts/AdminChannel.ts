export const AdminChannelDisabledCountries = {
  AF: "AF",
  AL: "AL",
  DZ: "DZ",
  AD: "AD",
...
export type AdminChannelDisabledCountries = (typeof AdminChannelDisabledCountries)[keyof typeof AdminChannelDisabledCountries]
export type AdminChannel = {
   ...
   * @type array
   */
  disabled_countries: AdminChannelDisabledCountries[]
  /**
   * @type string | undefined
   */
