...
export type AdminUserCountry = (typeof AdminUserCountry)[keyof typeof AdminUserCountry]
export type AdminUser = {
   ...
   * @type boolean | undefined
   */
  is_balance_replenishment_disable?: boolean
  /**
   * @type boolean | undefined
   */
  is_balance_replenishment_with_bonus_disable?: boolean
  /**
   ...
   * @type string | undefined
   */
  readonly register_referral_link?: string
  /**
   * @type integer | undefined
   */
  readonly admin_group_ids?: number
  /**
   * @type string | undefined
   */
  readonly user_payment_systems?: string
}
