export const AdminUserListCountry = {
  AF: "AF",
  AL: "AL",
  DZ: "DZ",
  AD: "AD",
...
export type AdminUserListCountry = (typeof AdminUserListCountry)[keyof typeof AdminUserListCountry]
