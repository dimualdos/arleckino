...
import { Groups } from "../../../UpdateChannels/ui/Groups"
import { Content } from "../../../UpdateChannels/ui/Content"
...
import { GridCountProps, GroupItemProp } from "../../../UpdateChannels/types"
...
export const AddDeviceChannels: FC<ComponentProps> = () => {
      ...
      <div className="flex flex-1 flex-col">
        <div className="flex flex-1 flex-col bg-blue-soft">
          ...
          <div className="border-b border-b-grey-soft lg:hidden">
            <div className="container flex items-start pb-6">
