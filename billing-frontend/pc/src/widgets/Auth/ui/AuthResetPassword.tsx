...
export const AuthChangePassword: FC<ComponentProps> = () => {
  ...
  const successTitleView = (
    <h1 className="max-w-[485px] self-center text-64 font-semibold text-background lg:hidden" dangerouslySetInnerHTML={{__html: t.raw("signUp.confirmTitleBlack")}}/>
      ...
      <div className="relative space-y-2">
        ...
        <Input
          {...useFormValidation.register("email", {
            ...
            validate: (value) => {
              return value.length < 2 ? t("emptyEmail") : true
            },
          })}
        />
