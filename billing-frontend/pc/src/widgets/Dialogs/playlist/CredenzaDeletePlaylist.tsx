...
export const CredenzaDeletePlaylist = ({ isOpen, onChange, onSubmit }: Props) => {
  return (
    <Credenza
      open={isOpen}
      ...
      <CredenzaContent className="block p-0">
        <div className="relative flex items-start space-x-3.5 border-b p-6 md:space-x-0 md:border-b-0 md:pb-4">
          ...
          <div className="relative flex-1 space-y-2">
            <p className="text-xl font-bold">Удаление плейлиста</p>
            <p>Плейлист и его данные будут безвозвратно удалены. Продолжить?</p>
          </div>
        </div>
        <div className="flex items-center justify-end space-x-2 px-6 py-4 md:grid md:grid-cols-2">
          ...
          <Button className="uppercase">Удалить</Button>
        </div>
      </CredenzaContent>
    </Credenza>
  )
